...
#'
#' @examples
#' rotating_panel_222(40)
#' rotating_panel_222(40, value_initial = "A")
#' rotating_panel_222(5, value_initial = "A")
#'
#' @export
rotating_panel_222 <- function(n_periods, value_initial = "A") {
  ...
  df_possibleScenarios2ndVisit <- utils_admissible_scenarios_222(
    n_periods = n_compute,
...
#'
#' @examples
#' utils_admissible_scenarios_222(n_periods = 40, vctr_rep1stLetterCols = 1:4,
#'                                str_blockInitLetter = "A")
#'
#' @export
utils_admissible_scenarios_222 <- function(n_periods = 40,
                                           vctr_rep1stLetterCols = 1:4,
                                           str_blockInitLetter) {
  ...
  for (i in 1:nrow(grid_2ndLetter)) {
    lst_possibleOutcomes[[i]] <- utils_minimal_block_222(
      n_periods = n_periods,
      vctr_rep1stLetterCols = vctr_rep1stLetterCols,
  ...
  for (i in 1:nrow(grid_2ndLetter)) {
    vctr_globalTest[i] <- utils_test_contiguous_222(lst_possibleOutcomes[[i]])$globalTest
  }
...
#'
#' @examples
#' utils_minimal_block_222(40, 1:4, c(1, 3, 1, 3), "A")
#'
#' @export
utils_minimal_block_222 <- function(n_periods, vctr_rep1stLetterCols,
...
#'
#' @examples
#' block <- utils_minimal_block_222(40, 1:4, c(1, 3, 1, 3), "A")
#' utils_test_contiguous_222(block)
#'
#' @export
utils_test_contiguous_222 <- function(block) {
