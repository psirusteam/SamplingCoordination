...
#' @description
#' This function generates random numbers using two different methods: Permutation and
#' "colocated" random numbers. Additionally, it can generate Pareto and PPS random numbers
#' if the corresponding parameters are specified.
#' @return
...
#' @param xk vector of weights for PPS or Pareto distributions. If NULL, the function
#'   will not generate PPS or Pareto random numbers.
#' @param Pareto a boolean indicating whether to generate Pareto random numbers (TRUE)
#'   or not (FALSE)
#' @param n a parameter for the Pareto distribution. If NULL, the function will not
